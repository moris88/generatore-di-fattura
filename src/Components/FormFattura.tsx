...
function FormFattura({
	...
	return (
		<div className="space-y-6">
			<h2 className="font-bold text-lg">Inserisci dati fattura</h2>

			{/* Numero e Data */}
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
				<div className="flex flex-col">
					<label className="font-medium text-sm" htmlFor="numero">
						Numero Fattura (Automatico)
					</label>
					<input
						readOnly
						className="cursor-not-allowed rounded border border-gray-300 bg-gray-50 p-2 font-bold font-mono text-gray-500"
						id="numero"
						type="text"
				...
				<div className="flex flex-col">
					<label className="font-medium text-sm" htmlFor="data">
						Data
					</label>
					<input
				...
				<div className="flex flex-col">
					<label className="font-medium text-sm" htmlFor="luogo">
						Luogo
					</label>
					<input
						className="rounded border border-gray-300 p-2"
			...
			<div className="rounded-lg border border-gray-300 bg-gray-50 p-4 shadow-sm">
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="emittente-nome">
							Ragione sociale *
						</label>
						<input
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="emittente-piva">
							P.IVA *
						</label>
						<input
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="emittente-email">
							Email *
						</label>
						<input
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="emittente-pec">
							PEC
						</label>
						<input
							className="rounded border border-gray-300 p-2"
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="emittente-telefono">
							Telefono
						</label>
						<input
							className="rounded border border-gray-300 p-2"
			...
			<div className="rounded-lg border border-gray-300 bg-gray-50 p-4 shadow-sm">
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="cliente-nome">
							Ragione sociale *
						</label>
						<input
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="cliente-indirizzo">
							Indirizzo
						</label>
						<input
							className="rounded border border-gray-300 p-2"
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="cliente-piva">
							P.IVA *
						</label>
						<input
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="cliente-email">
							Email/PEC *
						</label>
						<input
					...
					<div className="flex flex-col">
						<label className="font-medium text-sm" htmlFor="cliente-telefono">
							Telefono
						</label>
						<input
							className="rounded border border-gray-300 p-2"
					...
					{fattura.prodotti.map((p, idx) => (
						...
						>
							<div className="flex flex-3 flex-col">
								...
								<textarea
									className={`min-h-10 resize-y rounded border p-2 ${getErrorClass(`prodotti.${idx}.descrizione`)}`}
									id={`descrizione-${idx}`}
							...
							<div className="grid flex-2 grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-4">
								...
								<div className="flex flex-col">
									...
									<div
										id={`totale-${idx}`}
										className="flex h-10 items-center overflow-hidden whitespace-nowrap rounded border bg-gray-100 px-2 font-medium text-sm"
									>
										€
										{(p.quantita * p.prezzo_unitario - (p.sconto ?? 0)).toFixed(
											2,
										)}
									</div>
								</div>
			...
			<div className="rounded-lg bg-gray-100 p-6">
				<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
					...
					<div className="space-y-2 text-right md:col-span-2 lg:col-span-1">
						...
						<div className="flex justify-between border-gray-300 border-t pt-2 font-bold text-xl md:justify-end md:gap-8">
							<span>Totale:</span>
